...
$(GPU_FLOYD): floyd.cu $(GRAPH_UTILS_OBJ) $(APSP_CPU_OBJ) $(FLOYD_GPU_OBJ) | $(BIN_DIR)
	$(NVCC) $(NVCCFLAGS) $< $(GRAPH_UTILS_OBJ) $(APSP_CPU_OBJ) $(FLOYD_GPU_OBJ) -o $@

$(GPU_DIJKSTRA): Dijkstra.cu $(GRAPH_UTILS_OBJ) $(APSP_CPU_OBJ) $(DIJKSTRA_GPU_OBJ) | $(BIN_DIR)
	$(NVCC) $(NVCCFLAGS) $< $(GRAPH_UTILS_OBJ) $(APSP_CPU_OBJ) $(DIJKSTRA_GPU_OBJ) -o $@
